...
export default function RegistrarAlertaManutencao() {
  ...
  const enviarAlerta = async () => {
    try {
      ...
      Alert.alert(
        "Sucesso",
        "Alerta enviado. A equipe de manutenção será notificada.",
      );
      // volta para trás
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <ThemedText type="title" style={styles.title}>
            <MaterialCommunityIcons name="wrench" size={28} /> Solicitar
            Manutenção
          </ThemedText>
            ...
            <View style={{ marginTop: 8 }}>
              ...
              <View style={[styles.pickerWrap, { borderColor: theme.border }]}>
                <Picker
                  ...
                  style={
                    Platform.OS === "android"
                      ? { color: tipo ? theme.text : "#9aa0a6" }
                      : undefined
                  }
                >
                  <Picker.Item label="Selecione o tipo" value="" />
                  <Picker.Item
                    label="Solicitação de manutenção (motorista solicita reparo)"
                    value="SOLICITACAO"
                  />
                  <Picker.Item
                    label="Registro rápido (manutenção pequena já realizada)"
