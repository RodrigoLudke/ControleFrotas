      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <ThemedText type="title" style={styles.title}>
            <MaterialCommunityIcons name="fuel" size={28} /> Registrar
            Abastecimento
          </ThemedText>
          ...
          <View style={[styles.section, { backgroundColor: theme.card }]}>
            ...
            <View style={styles.row}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <View
                  style={[styles.pickerWrap, { borderColor: theme.border }]}
                >
                  <Picker
                    ...
                    style={
                      Platform.OS === "android"
                        ? { color: combustivel ? theme.text : "#9aa0a6" }
                        : undefined
                    }
                  >
          ...
          <View style={[styles.section, { backgroundColor: theme.card }]}>
            <ThemedText style={styles.sectionTitle}>
              <MaterialCommunityIcons name="speedometer" size={14} /> Medidas e
              Valores
            </ThemedText>
