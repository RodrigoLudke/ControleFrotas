...
import {Calendar, Edit, Eye, Fuel, Gauge, MapPin, Plus, Search, Trash2} from "lucide-react";
                                ...
                                <TableBody>
                                    {filteredVehicles.map((vehicle) => (
                                        <TableRow key={vehicle.id} className="hover:bg-muted/50">
                                            ...
                                            <TableCell
                                                className="font-mono font-medium">{vehicle.placa || 'N/A'}</TableCell>
                                            <TableCell>
                                            ...
                                            <TableCell>
                                                <div className="space-y-1">
                                                    <div
                                                        className="text-sm">Última: {formatDate(vehicle.ultimaManutencao)}</div>
