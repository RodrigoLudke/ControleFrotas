...
const vehicleCreateSchema = z.object({
  ...
  renavam: z
    .string()
    .min(9, "RENAVAM deve ter pelo menos 9 dígitos")
    .max(11, "RENAVAM muito longo"),
  fuel: z.enum(
  ...
  insuranceCompany: z
    .string()
    .max(100, "Nome da seguradora muito longo")
    .optional(),
  insurancePolicy: z
    .string()
    .max(50, "Número da apólice muito longo")
    .optional(),
      ...
      try {
        ...
        if (res.ok) {
          ...
          setFormData({
            ...
            capacity:
              data.capacidade !== undefined && data.capacidade !== null
                ? String(data.capacidade)
                : "",
            mileage:
              data.quilometragem !== undefined && data.quilometragem !== null
                ? String(data.quilometragem)
                : "",
            purchaseDate: data.dataCompra
              ? new Date(data.dataCompra).toISOString().slice(0, 10)
              : "",
            purchaseValue:
              data.valorCompra !== undefined && data.valorCompra !== null
                ? String(data.valorCompra)
                : "",
            insuranceCompany: data.seguradora ?? "",
            insurancePolicy: data.apoliceSeguro ?? "",
            insuranceExpiry: data.validadeSeguro
              ? new Date(data.validadeSeguro).toISOString().slice(0, 10)
              : "",
          ...
          const err = await res
            .json()
            .catch(() => ({ error: "Veículo não encontrado." }));
          toast({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const validatedData = id
        ? vehicleEditSchema.parse(finalData)
        : vehicleCreateSchema.parse(finalData);
      //eslint-disable-next-line @typescript-eslint/no-explicit-any
      ...
      if (response.ok) {
        toast({
          ...
          description: id
            ? "Alterações salvas."
            : `${validatedData.brand} ${validatedData.model} (${validatedData.plate}) cadastrado.`,
          variant: "default",
        });
        navigate("/veiculos");
      } else {
        const errorData = await response
          .json()
          .catch(() => ({ error: "Erro ao salvar veículo." }));
        toast({
          title: "Erro",
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleInputChange("vehicleTypes", value)
                      }
                    >
                      <SelectTrigger
                        className={cn(
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger
                        className={errors.fuel ? "border-destructive" : ""}
                      >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("purchaseValue", e.target.value)
                      }
                      className={
                        errors.purchaseValue ? "border-destructive" : ""
                      }
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className={
                        errors.insurancePolicy ? "border-destructive" : ""
                      }
                      placeholder="123456789"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className={
                        errors.insuranceExpiry ? "border-destructive" : ""
                      }
                    />
