    ...
    const fetchAll = async () => {
        ...
        try {
            ...
            if (resM.ok) {
                ...
                toast({
                    title: "Erro",
                    description: err.error || "Não foi possível carregar manutenções.",
                    variant: "destructive"
                });
                setManutencoes([]);
            }
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-between">
                    ...
                    <div className="flex gap-2">
                        <Button onClick={() => navigate("/registrarmanutencoes")}
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {loading ? (
                                            ...
                                            <TableRow key={m.id} className="hover:bg-muted/50">
                                                <TableCell>
                                                    <div>
                                                        ...
                                                        <div
                                                            className="text-sm text-muted-foreground">{m.veiculo?.modelo ?? ""}</div>
                                                    </div>
                                                </TableCell>
                                                ...
                                                <TableCell>
                                                    ...
                                                    <div
                                                        className="text-sm text-muted-foreground">{m.user?.email ?? ""}</div>
                                                </TableCell>
                                                ...
                                                <TableCell
                                                    className="max-w-sm truncate">{m.descricao ?? "—"}</TableCell>
                                        ...
                                        <TableRow>
                                            <TableCell colSpan={8} className="text-center py-8 text-muted-foreground">Nenhuma
                                                manutenção encontrada</TableCell>
                                        </TableRow>
                                    )}
                                </TableBody>
                            </Table>
